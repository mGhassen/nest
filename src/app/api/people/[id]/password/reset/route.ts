...
export async function POST(
  ...
  try {
    ...
    // Get the employee record with account information
    ...
    console.log('Sending password reset email to employee:', employee.accounts.email);
    ...
    try {
      await supabaseServer()
        ...
        .insert({
          ...
          description: `Password reset email sent by admin for employee ${employee.first_name} ${employee.last_name}`,
          metadata: {
    ...
    console.log('Password reset email sent successfully to:', employee.accounts.email);
